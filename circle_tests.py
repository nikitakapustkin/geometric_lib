...
class CircleTestCase(unittest.TestCase):
    ...
    def test_float_area(self):
        res = circle.area(1.2)
        self.assertAlmostEqual(res, 4.523, delta=0.1)

    def test_int_area(self):
        res = circle.area(4543543)
        self.assertAlmostEqual(res, 64854356992636.336, delta=0.1)
    ...
    def test_float_perimeter(self):
        ...
        self.assertAlmostEqual(res, 21.362830044410593, delta=0.1)

    def test_int_perimeter(self):
        res = circle.perimeter(325235)
        self.assertAlmostEqual(res, 2043511.7733805527, delta=0.1)
